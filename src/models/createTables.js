...
const tablas = [
  ...
  "CREATE TABLE Tablero_Imagenes(id SERIAL PRIMARY KEY, id_tablero INT NOT NULL, id_imagen INT NOT NULL, posicion INT, visible INT DEFAULT 1, enlazada INT DEFAULT 0, descripsion VARCHAR(60) DEFAULT '', FOREIGN KEY(id_tablero) REFERENCES Tablero(id), FOREIGN KEY(id_imagen) REFERENCES Imagen(id));",
  ...
  'CREATE TABLE Bonus(id SERIAL PRIMARY KEY, tipo VARCHAR(30), duracion INT, descripcion VARCHAR(60) );',
  'CREATE TABLE Partida_Bonus(id SERIAL PRIMARY KEY, id_partida INT NOT NULL, id_bonus INT NOT NULL, usado INT DEFAULT 0, FOREIGN KEY(id_partida) REFERENCES Partida(id), FOREIGN KEY(id_bonus) REFERENCES Bonus(id) );',
];
